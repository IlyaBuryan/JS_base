...
const snake = {
    ...
    // Добавлена функция выведения счета, которая запускается при запуске makeStep() 
    drawscore() {
        let score = document.getElementById("score");
        score.innerText = `Текущий счет ${this.body.length - 1}`;
    },
...
const game = {
    ...
    reset() {
        ...
        // Удаление текста счета при сбросе игры
        let score = document.getElementById("score");
        score.innerText = ``;
    },
